    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="/w3images/lights.jpg" target="_blank">
          <img src="Modeling.jpg" alt="Lights" style="width:100%">
          <div class="caption">
            <p>Modeling Shoot.</p>
            <p>1 hr |  Introductory Meeting
Describe your service here. What makes it great? Use short catchy text to tell people what you offer, and the benefits they will receive. A great description gets readers...
Learn More</p>
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="/w3images/fjords.jpg" target="_blank">
          <img src="STL.jpg" alt="Fjords" style="width:100%">
          <div class="caption">
            <p>Still Life Shoot.</p>
            <p>1 hr | Introductory Meeting
Describe your service here. What makes it great? Use short catchy text to tell people what you offer, and the benefits they will receive. A great description gets readers...
Learn More</p>
<button class="button">Let's Meet</button>
